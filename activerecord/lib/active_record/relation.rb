...
module ActiveRecord
  ...
  class Relation
    ...
    # the same set of columns in the conditions hash.
    #
    # For the common case where the conditions hashes identify records by the
    ...
    def update_in_bulk(updates, record_timestamps: nil)
      updates = UpdateInBulk.normalize_updates(model, updates)
      ...
      model.with_connection do |c|
        ...
        values_table, join_conditions, set_assignments = UpdateInBulk.new(self, c, updates, record_timestamps:).build_arel
        ...
        puts stmt.to_sql(ActiveRecord::Base)
